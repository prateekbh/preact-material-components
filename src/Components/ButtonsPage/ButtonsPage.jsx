	...
	render(){
		...
		return (
			<div className="page-buttons">
				...
				<Button raised accent>Accented Raised button</Button>
				...
				<Button unelevated ripple>Unelevated button with ripple</Button>
				<Button unelevated accent>Accented Unelevated button</Button>
				<Button unelevated dense>Dense Unelevated button </Button>
				<Button unelevated compact>Compact Unelevated button </Button>
				<Button unelevated primary>Primary Unelevated button </Button>

				<div className="mdc-typography--title">Stroked </div>
				<Button stroked>Stroked button without ripple</Button>
				<Button stroked ripple>Stroked button with ripple</Button>
				<Button stroked accent>Accented Stroked button</Button>
				<Button stroked dense>Dense Stroked button </Button>
				<Button stroked compact>Compact Stroked button </Button>
				<Button stroked primary>Primary Stroked button </Button>

				<div className="mdc-typography--title">Disabled </div>
				<Button disabled>Disabled button without ripple</Button>
				<Button disabled ripple>Disabled button with ripple</Button>
				<Button disabled accent>Accented Disabled button</Button>
				<Button disabled dense>Dense Disabled button </Button>
				<Button disabled compact>Compact Disabled button </Button>
				<Button disabled primary>Primary Disabled button </Button>
