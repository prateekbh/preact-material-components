	...
	render(){
		return (
          ...
          This component encapsulates <span className="strong">mdc-textfield</span>. You can refer to its documentation
				...
				<div className="mdc-typography--headline">With persistent help text</div>
				<Textfield label="Persistent help text" helptext="This is the helptext" helptextPersistent />
