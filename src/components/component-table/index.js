...
export default class ComponentTable extends Component {
	render(){
		return (
			<div>
				<div className="mdc-typography--display1">Components and their props</div>
				<ul>
					{this.props.data.map(component=>{
						return (<li>
							<div className="mdc-typography--headline">{component.component}</div>
							<ul>
								{
									component.props && component.props.map(prop=>{
										return (
											<li>
												<div>
								...
								{
									component.props.length === 0 && <li><div className="mdc-typography--caption">no specific props</div></li>
								}
							</ul>
						</li>);})}
				</ul>
